...
(library Library_1
	...
	(compDef "AD5693RARMZ" (originalName "AD5693RARMZ") (compHeader (numPins 10) (numParts 1) (refDesPrefix IC)
		...
		(compPin "10" (pinName "VOUT") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "7" (pinName "SCL") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "A0") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.analog.com/media/en/technical-documentation/data-sheets/ad5693r_5692r_5691r_5693.pdf")
		(attr "Height" "1.1 mm")
	)
