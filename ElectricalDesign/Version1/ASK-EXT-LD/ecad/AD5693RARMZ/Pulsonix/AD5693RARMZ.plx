...
//327617/1632075/2.50/10/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "AD5693RARMZ" (originalName "AD5693RARMZ")
	...
	(compDef "AD5693RARMZ" (originalName "AD5693RARMZ") (compHeader (numPins 10) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "10" (pinName "VOUT") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "7" (pinName "SCL") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "A0") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AD5693RARMZ"))
		...
		(attr "Mouser Part Number" "584-AD5693RARMZ")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Analog-Devices/AD5693RARMZ?qs=vPP9GyyTAo0MlAXojaRB6w%3D%3D")
		(attr "Manufacturer_Name" "Analog Devices")
		(attr "Manufacturer_Part_Number" "AD5693RARMZ")
		(attr "Description" "Analog Devices AD5693RARMZ, 16 bit Serial DAC, 10-Pin MSOP")
		(attr "<Hyperlink>" "https://www.analog.com/media/en/technical-documentation/data-sheets/ad5693r_5692r_5691r_5693.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "AD5693RARMZ.stp")
