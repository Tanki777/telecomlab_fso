...
//338123/1632075/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "INA301A1IDGKR" (originalName "INA301A1IDGKR")
	...
	(compDef "INA301A1IDGKR" (originalName "INA301A1IDGKR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "VS") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "OUT") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "LIMIT") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "7" (pinName "IN-") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "__ALERT") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "RESET") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "INA301A1IDGKR"))
		...
		(attr "Mouser Part Number" "595-INA301A1IDGKR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/INA301A1IDGKR?qs=yajEpaT76uR6go0HjUkNgA%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "INA301A1IDGKR")
		(attr "Description" "36V, Low-/High-side, Voltage Output CSA with Comparator")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/INA301")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "INA301A1IDGKR.stp")
