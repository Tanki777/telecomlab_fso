...
(library Library_1
	...
	(compDef "INA301A1IDGKR" (originalName "INA301A1IDGKR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "3" (pinName "LIMIT") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "7" (pinName "IN-") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "__ALERT") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "RESET") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://www.ti.com/lit/gpn/INA301")
		(attr "Height" "1.1 mm")
	)
